...
- status: complete; committed as 69fc770.
...
- review status: passed after 1 cycle; the publication transaction preserves existing decisions, validates before mutation, publishes units atomically and rejects reprocessing, while the stale-safe frontend refreshes both the approved summary and its units.
