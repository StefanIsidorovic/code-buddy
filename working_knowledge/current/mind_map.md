...
- mind_map/frontend-terminal.md: React/xterm terminal panel, keyboard input path, output rendering path, runtime sidebar, Session History replay/filter/rename controls, ACP launch controls, earth-tone UI palette/font rules, layout constraints, and UI risks.
...
- mind_map/workspace-persistence.md: SQLite project storage, ACP transcript persistence/replay/rename, manual Knowledge Cards, Workspace/Session History UI state, selected cwd launch wiring, and deferred persistence scope.
