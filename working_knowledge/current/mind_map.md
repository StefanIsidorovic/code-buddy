...
- mind_map/workspace-persistence.md: SQLite project storage, ACP transcript persistence, Workspace/Session History UI state, selected cwd launch wiring, and deferred persistence scope.
