...
## Next Step
- Extract the Initialization Details dialog as the next initialization feature slice, keeping view selection, Summary approval, Knowledge Unit loading, and all async mutations in App.
