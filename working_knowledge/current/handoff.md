...
## Next Step
- Extract the repository management dialog as the next workspace feature slice, keeping selection, persistence, native folder picking, and delete/create orchestration in App.
