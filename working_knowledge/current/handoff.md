...
## Next Step
- Project catalog, initialization, Knowledge, transcript, ACP and PTY runtime orchestration are extracted; isolate Agent Doctor/model catalog orchestration next, then perform thin-root cleanup and code splitting.
