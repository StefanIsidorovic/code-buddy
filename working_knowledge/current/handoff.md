...
## Next Step
- Extract the workspace management dialog as the next workspace feature slice, keeping persistence, folder picking, project deletion confirmation, and create/select orchestration in App.
