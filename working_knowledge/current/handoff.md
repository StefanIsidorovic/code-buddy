...
## Next Step
- Project/repository catalog orchestration is extracted; split Project Initialization orchestration next, then isolate ACP/transcript workflows and leave App as root composition.
