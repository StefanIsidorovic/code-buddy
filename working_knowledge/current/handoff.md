...
## Next Step
- Extract the New Knowledge Card dialog as the next bounded knowledge feature slice, keeping card creation, attachment, persistence, loading/error lifecycle, and visibility in App.
