...
- `src/App.tsx` is now 3,025 lines after staged extraction, but remains the primary maintainability risk before several more stateful frontend workflows are added.
