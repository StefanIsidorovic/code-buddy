...
## Repository State
- branch: new/start
- head: this commit, step 22.21: surface actionable ACP startup failures (parent 728402d)
- worktree: plan item 22.21 complete and ready to commit.
...
- phase: complete
- active plan step: 22.21 complete
