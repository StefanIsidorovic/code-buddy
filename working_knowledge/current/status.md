...
## Repository State
- branch: new/start
- head: 3e80041 step 37.5a.2: derive execution waves
- worktree: clean before final working-knowledge synchronization
- relevant files: explicit step dependencies, deterministic execution-wave derivation and safety preview

## Current Task
- request: evolve Task workflow toward structured steps, small-model routing, evaluation, critique and safe parallel work
- phase: in progress
- active plan step: 37.5a.2 complete; isolated wave execution next
