...
- ACP model availability: session-advertised model options are not proof of runtime/config compatibility; never infer coding availability from the separate synthesis API catalog or hardcoded model names.
