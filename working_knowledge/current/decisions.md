...
- Guided phase UI: Run and Prepare are optional helpers because manual evidence remains valid; Save evidence, Review, and Complete reflect the real backend gates, and completion reveals but never starts the next phase.
